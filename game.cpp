/*
description: this cpp file contains the code to store piece positions, translations, and creating new pieces
...
void Game::DrawPiece (int px, int py, int pPiece, int pRotation)
{
	...
	// Obtain the position in pixel  of the block we want to draw
